...
import com.swisui.pm.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            em.deleteAll("_user_authority").block();
