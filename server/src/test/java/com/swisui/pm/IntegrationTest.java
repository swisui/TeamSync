package com.swisui.pm;

import com.swisui.pm.ServerApp;
import com.swisui.pm.config.AsyncSyncConfiguration;
import com.swisui.pm.config.EmbeddedSQL;
...
@SpringBootTest(classes = { ServerApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
